<?php
class Themezone_Options_icon extends Themezone{
	...
	function render( $meta = false ){
		...
		// echo -----------------------------------------------------
		echo '<div class="zn-icon-field">';

			echo '<div class="zn-icon-header">';

				echo '<input type="text" '. $name .' value="'. $value .'" class="zn-icon-input '. $class .'"/>';
			...
			echo '<div class="zn-icon-select">';

				foreach( $this->icons as $icon ){
					$iclass = ( $value == $icon ) ? ' active' : '';
					echo '<span class="zn-icon'. $iclass .'" data-rel="'. $icon .'"><i class="'. $icon .'"></i></span>';
				}
	...
	*/
	function enqueue(){
		wp_enqueue_script( 'zn-opts-field-icos-js', THEME_URI. '/themezone-options/fields/icon/field_icon.js', array( 'jquery' ), THEME_VERSION, true );
	}
